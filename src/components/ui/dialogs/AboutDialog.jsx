      ...
      <div style={{ padding: '16px', maxHeight: '70vh', overflowY: 'auto' }}>
        ...
        <div
          style={{
            ...
            padding: '24px',
            background:
              'linear-gradient(135deg, var(--overlay-on-light-8) 0%, var(--overlay-on-light-4) 100%)',
        ...
        >
          ...
          <div
            ...
            onClick={() =>
              window.electronAPI?.openExternal?.('https://github.com/Magstic/J2ME-Launcher')
            }
            onMouseEnter={(e) => {
          ...
          <div
            ...
            onClick={() =>
              window.electronAPI?.openExternal?.('https://en.wikipedia.org/wiki/MIT_License')
            }
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = 'var(--overlay-on-light-08)';
            }}
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <div
            ...
            onClick={() =>
              window.electronAPI?.openExternal?.('https://github.com/TASEmulators/freej2me-plus')
            }
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = 'var(--overlay-on-light-08)';
          ...
          >
            ...
            <p style={{ margin: '0 0 8px 0', fontSize: '12px', color: 'var(--text-primary)' }}>
              {t('about.maintainer') + 'AShiningRay'}
            </p>
            <p
              style={{
                margin: '0',
        ...
        <div style={{ marginBottom: '24px' }}>
          <AboutNetworkCard
            developer={{
              id: 'magstic',
              name: 'Magstic (Developer)',
              link: 'https://magstic.art',
              avatarUrl: getAvatar('magstic'),
            }}
            testers={[
              {
                id: 'lavinia-616',
                name: 'lavinia-616 (Tester)',
                link: 'https://github.com/lavinia-616',
                avatarUrl: getAvatar('lavinia'),
              },
