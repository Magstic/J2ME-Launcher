 ...
 */
export default function ClusterSelectDialog({
  isOpen,
  onClose,
  onSelect,
  folderId = null,
  ...
  return (
    <ModalWithFooter isOpen={!!isOpen} onClose={onClose} title={title} size="md" footer={footer}>
