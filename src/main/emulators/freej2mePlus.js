    ...
    groups: [
      {
        ...
        fields: [
          ...
          { key: 'framerate', type: 'select', label: '幀率（framerate）', options: [60,55,50,45,40,35,30,25,20,15,10] },
          { key: 'keyLayout', type: 'select', label: '鍵位佈局（keyLayout）', options: [
          ...
          { key: 'backlightcolor', type: 'select', label: '背光顏色（backlightcolor）', options: ['Disabled','Green','Cyan','Orange','Violet','Red'] },
          { key: 'fontoffset', type: 'select', label: '字體尺寸（fontoffset）', options: ['-4','-3','-2','-1','0','1','2','3','4'] },
          { key: 'rotate', type: 'select', label: '螢幕旋轉（rotate）', options: ['0','90','180','270'] },
          { key: 'fpshack', type: 'select', label: 'FPS HACK（fpshack）', options: ['0','1','2','3'] },
